...
<body>
	<p>Wählen Sie einen Datensatz den Sie verändern wollen <br/>und senden Sie das Formular ab:</p>
...
<?php
	...
	echo "<p><input type='submit' name='gesendet' value='Auswahl bearbeiten'/>";
